...
// export const SOCKET_EVENT_ADD_MSG = 'chat-add-msg'
// export const SOCKET_EMIT_SEND_MSG = 'chat-send-msg'
export const SOCKET_EMIT_SET_WATCHED_BOARED = 'set-watched-board'
export const SOCKET_EVENT_WATCHED_BOARD_UPDATED = 'watched-board-updated'
// export const SOCKET_EMIT_USER_WATCH = 'user-watch'
export const SOCKET_EVENT_BOARD_ADDED = 'board-added'
// export const SOCKET_EVENT_BOARD_REMOVED = 'board-removed'
// export const SOCKET_EVENT_BOARD_ABOUT_YOU = 'board-about-you'
